...
- [x] 1. Set up project structure and dependencies
  ...
  - [x] 1.2 Install and configure Tailwind CSS, shadcn/ui, TanStack Query, and React Router
...
- [x] 2. Implement API client layer and data types
  - [x] 2.1 Create TypeScript interfaces for all API response shapes
  ...
  - [x] 2.2 Implement the `apiFetch` generic function and `ApiError` class
  ...
  - [x] 2.3 Write property tests for API client (Properties 1, 2, 3)
  ...
  - [x] 2.4 Implement typed endpoint wrapper functions
...
- [x] 3. Implement utility functions
  ...
  - [x] 3.2 Write property tests for formatting utilities (Properties 9, 10)
  ...
  - [x] 3.3 Create sorting utilities
  ...
  - [x] 3.4 Write property tests for sorting utilities (Properties 5, 8)
  ...
  - [x] 3.5 Create filtering utilities
  ...
  - [x] 3.6 Write property tests for filtering utilities (Properties 6, 7)
  ...
  - [x] 3.7 Create link and expiry utilities
  ...
  - [x] 3.8 Write property tests for link and expiry utilities (Properties 11, 13)
...
- [x] 6. Implement app shell and routing
  - [x] 6.1 Set up React Router with layout and navigation
  ...
  - [x] 6.2 Write property test for undefined routes (Property 4)
...
- [x] 7. Implement TanStack Query hooks
  - [x] 7.1 Create data-fetching hooks
...
- [x] 8. Implement Runs List Page
  - [x] 8.1 Build RunsListPage component
...
- [x] 9. Implement Run Detail Page
  - [x] 9.1 Build RunDetailPage component
...
- [x] 11. Implement Tender List Page
  - [x] 11.1 Build TenderListPage component
...
- [x] 12. Implement Tender Detail Page
  - [x] 12.1 Build TenderDetailPage component
  ...
  - [x] 12.2 Write property test for warnings rendering (Property 12)
...
- [x] 13. Implement error handling patterns
  - [x] 13.1 Add error handling to all pages
...
- [x] 14. Static build configuration
  - [x] 14.1 Configure production build for S3 + CloudFront hosting
